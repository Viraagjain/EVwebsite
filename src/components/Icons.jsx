export const LogoIcon = (props) => (
  <svg
    ...
    {...props}
  >
    {/* Replace the 'image' element with your 'logo.jpeg' SVG code or shape */}
    <image href="evwebsite/src/components/logo.jpeg" width="256" height="256" />
  </svg>
);
  ...
  export const HamburgetMenuOpen = (props) => (
    <svg
      ...
      {...props}
    >
      <path fill="rgba(0, 255, 0, 0)" d="M0 0h24v24H0z" />
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
